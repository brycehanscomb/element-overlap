...
import { intersection as getIntersectionData } from '../node_modules/mezr/mezr.js';
import contains from  '../node_modules/contains/index.js';
 ...
 */
function listenForOverlap(element1, element2, callback, options = {}) {
    if (!element1) {
